...
def main():
    ...
    device, img_binary = pcv.binary_threshold(img_gray_sat, 70, 255, 'light', device, debug)
    ...
    cv2.putText(maxseed, imgtext, (500, 300), cv2.FONT_HERSHEY_SIMPLEX, 5, (0, 0, 0), 10)
    cv2.putText(maxseed, sizeseed, (500, 600), cv2.FONT_HERSHEY_SIMPLEX, 5, (0, 0, 0), 10)
